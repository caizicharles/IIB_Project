...
RECORD_TEMPLATE = {'patient_id': None,
                   'ecg': None,
                   'spectrogram': None,
                   'sampling_freq': None,
                   'label': None}
...
def run(args):
  ...
  if not (osp.exists(train_data_path) and osp.exists(val_data_path) and osp.exists(test_data_path)):
    ...
    splitted_data = split_data(constructed_data, split_ratio=split_ratio, split_mode='record', save=True,
                          save_path=save_path)

    train_data, val_data, test_data = splitted_data['train_data'], splitted_data['val_data'], splitted_data['test_data']
  else:
